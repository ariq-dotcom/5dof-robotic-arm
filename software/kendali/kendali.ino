//KELOMPOK 2 projek robot

// Ariq Suryaselpha Hamid
// Sofyan Adam Malik
// Noviana Rahmadhani
// Gilang Al Buqhori
// Wahyu Septian Wicahya
...
void mapkeServo(float t0, float t1, float t2, float t3, float t4,
                float *s0, float *s1, float *s2, float *s3, float *s4) {
  // =======================================
  // KOREKSI MEKANIK (Hasil perhitungan matematis disesuaikan 
  // dengan kalibrasi pemasangan servo)
  // =======================================
  *s0 = t0;
  *s1 = 180 - t1;
  *s2 = t2 + 180;
